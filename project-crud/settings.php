...
if (isset($_POST['save'])) {
    ...
    if ($row) {
        ...
        ");
    } else {mysqli_query($conn, "INSERT settings (website_name, email, phone, ig, address, description) VALUES('$website_name','$email', '$phone', '$ig', '$address', '$description')");
    }
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" required value=" <?php echo (isset($row) ? $row['phone'] : '') ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="ig" class="form-control" value=" <?php echo (isset($row) ? $row['ig'] : '') ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
