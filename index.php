...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
				...
				<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
					<div class="row justify-content-start pb-3">
						<div class="col-md-12 heading-section ftco-animate">
							...
							<p>Saya Seorang Sarjana Teknik Informatika yang sangat mahir semua tentang webprogramming</p>
							<ul class="about-info mt-4 px-md-0 px-2">
								<li class="d-flex"><span>Name:</span> <span>Muhammad Osvaldo Rios</span></li>
								<li class="d-flex"><span>Date of birth:</span> <span>Juli 16, 1999</span></li>
								<li class="d-flex"><span>Address:</span> <span>Bekas CA 12345 IND</span></li>
								<li class="d-flex"><span>Zip code:</span> <span>1000</span></li>
								<li class="d-flex"><span>Email:</span> <span>m.osvaladorios16@gmail.com</span></li>
								<li class="d-flex"><span>Phone: </span> <span>081298765432</span></li>
							</ul>
						</div>
					</div>
	...
	<section class="ftco-section ftco-project" id="projects-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url('images/project-4.jpg');<?php ?>">
						<div class="overlay"></div>
